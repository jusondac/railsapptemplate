...
class ProductImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_image" do
    assert_difference("ProductImage.count") do
      post product_images_url, params: { product_image: { image_url: @product_image.image_url, is_primary: @product_image.is_primary, product_id: @product_image.product_id } }
    end
  ...
  test "should update product_image" do
    patch product_image_url(@product_image), params: { product_image: { image_url: @product_image.image_url, is_primary: @product_image.is_primary, product_id: @product_image.product_id } }
